...
import './FileUploadForm.module.css'
      ...
      <div
        className={
          this.props.resultsPage
            ? 'file-upload apercupro-medium-black-16px'
            : 'file-upload file-upload-main apercupro-medium-black-16px'
        }
      >
        <div
          className={
            this.props.searchType === 'counterfeit'
              ? 'file-upload-half file-upload-half-left'
              : 'file-upload'
          }
        >
          <DragAndDrop handleDrop={this.handleDrop}>
            <label
              className={
                this.props.resultsPage
                  ? 'drag-and-drop-label center-vertically'
                  : 'drag-and-drop-label drag-and-drop-label-results center-vertically'
              }
            >
              ...
              <input
                type="file"
                name="file"
                className="file-upload-input center-vertically"
            ...
            <form className="file-upload-url-form" onSubmit={this.handleSubmit}>
              <div className="search-components search-components-url">
                <div
                  className={
                    this.props.resultsPage
                      ? 'search-box search-box-url-results'
                      : 'search-box search-box-url-main'
                  }
                >
                  <img
