...
class Results extends React.Component {
  ...
  componentDidMount() {
    ...
    if (query && type) {
      ...
      this.props.fileSearchInput &&
      this.props.fileSearchInput.file &&
      type
    ) {
        ...
        if (
          ...
          if (this.state.searchParams.value) {
            ...
            if (
              ...
              typeof this.state.searchParams.value === 'object'
            ) {
              searchQueries.searchCounterfeit(
    ...
    if (!this.state.searching) {
      ...
      if (searchType === 'counterfeit' && typeof value === 'object') {
        ...
        window.history.pushState(
          {},
          null,
          `/results?type=${searchType}&query=${value}`
        )
        searchQueries.search(
          value,
          searchType,
        ...
        <div className="container-center-horizontal">
          ...
          <div className="results screen">
            <div id="results" className="overlap-group-results">
              ...
              {this.state.searchingPage && <SkeletonLoader />}
            </div>
          </div>
          <div style={{ width: '10%' }} className="desktop-big" />
        </div>
