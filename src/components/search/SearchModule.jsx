...
class SearchModule extends React.Component {
  ...
  handleContractChange = (event) => {
    ...
    this.setState({
      counterfeitSearch: this.state.counterfeitSearch,
      error: '',
    })
  }
  ...
  handleQuerySubmit = (event) => {
    ...
    if (this.state.value) {
      ...
      this.props.onSubmit(this.state.searchType, this.state.urlValue, {
        filterAddress: this.state.counterfeitSearch.filterAddress,
      })
    } else if (
  ...
  render() {
    return (
      <div
        className={
          this.props.page ? 'search-module-results' : 'search-module-wrapper'
        }
        style={{
          background:
            this.state.showFileUpload && this.props.page
              ? 'var(--light-grey)'
              : '',
        }}
      >
        <form onSubmit={this.handleQuerySubmit}>
          <div
            className={
              this.props.page ? 'search-module-results' : 'search-module'
            }
            style={{
              background:
                this.state.showFileUpload && this.props.page
          ...
          >
            <div
              className={
                this.props.page
                  ? 'search-components search-components-results'
                  : 'search-components search-components-main'
              }
            >
                  ...
                  <div className="search-box-main">
                    ...
                    >
                      ...
                      <input
                        className={
                          this.props.page
                            ? 'desktop search-all-nfts-results'
                            : 'desktop search-all-nfts'
                        }
                      ...
                      <input
                        className={
                          this.props.page
                            ? 'mobile search-all-nfts-results'
                            : 'mobile search-all-nfts'
                        }
                ...
                <>
                  <div className="search-box-main">
                    ...
                    >
                      ...
                      />
                      <img
                        onClick={this.toggleFileUploader}
                        className="camera-image"
                        src={this.props.cameraImage}
                      />
                    </div>
                  </div>
                </>
              ...
              {this.state.searchType === 'counterfeit' && (
                <>
                  <div className="search-box-main">
                    <div
                      className={
                        this.props.page ? 'search-box-results' : 'search-box'
                      }
                    >
                      <img
                        className={
                      ...
                      <input
                        ...
                        value={this.state.counterfeitSearch.contractAddress}
                    ...
                    >
                      <input
                        className={
                          this.props.page
                            ? 'mobile search-all-nfts-results search-all-nfts-counterfeit'
                            : 'mobile search-all-nfts search-all-nfts-counterfeit'
                        }
                        placeholder="Token ID"
                        value={this.state.counterfeitSearch.tokenId}
                    ...
                    <div
                      className={
                        this.props.page
                          ? 'mobile extra-filters-text-results'
                          : 'mobile extra-filters-text'
                      }
                      style={{ marginTop: '20px' }}
                    >
                      Extra filters
                    ...
                    >
                      <input
                        ...
                        value={this.state.counterfeitSearch.filterAddress}
              ...
              <input
                ...
                className={
                  this.props.page
                    ? 'button-results search apercupro-medium-white-20px'
                    : 'button search apercupro-medium-white-20px'
                }
              />
            </div>
          </div>
          {this.state.searchType === 'counterfeit' && (
            <div
              className={
                this.props.page
                  ? 'desktop search-box-results search-box-counterfeit-results'
                  : 'desktop search-box search-box-counterfeit'
              }
            >
              <input
                className={
                  this.props.page
                    ? 'desktop search-all-nfts-results search-all-nfts-counterfeit'
                    : 'desktop search-all-nfts search-all-nfts-counterfeit'
                }
                placeholder="Token ID"
                value={this.state.counterfeitSearch.tokenId}
                onChange={this.handleTokenChange}
        ...
        {this.state.searchType === 'counterfeit' && (
          <>
            <div
              className={
                this.props.page
                  ? 'desktop extra-filters-text-results'
                  : 'desktop extra-filters-text'
              }
              style={{ marginTop: '20px' }}
